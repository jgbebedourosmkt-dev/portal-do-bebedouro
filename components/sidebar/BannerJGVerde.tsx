  ...
  return (
    ...
    >
      <div className="mb-2">
        ...
        <p className="text-[11px] text-white/60 mt-0.5">Condomínios & Escolas</p>
      </div>
      ...
      <a
        href="#"
        className="block w-full py-2.5 text-center text-[12px] font-black uppercase tracking-wide bg-white text-vd hover:bg-green-50 transition-colors"
        style={{ fontFamily: 'var(--font-barlow-condensed)' }}
      >
        Saiba mais →
      </a>
