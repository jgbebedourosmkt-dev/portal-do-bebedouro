    ...
    >
      ...
      <div className="relative z-10">
        <div className="mb-2">
          ...
          <p className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Purificadores</p>
        </div>
        <p className="text-[12px] text-white/60 mb-4 leading-relaxed italic">
        ...
        <div className="flex items-center gap-2 mb-4">
          {['ISO 9001', 'INMETRO', 'ANVISA'].map((cert) => (
            <span
              key={cert}
              className="px-2 py-0.5 text-[9px] font-bold border border-white/20 text-white/50 uppercase tracking-wide"
              style={{ fontFamily: 'var(--font-barlow-condensed)' }}
            >
              {cert}
            </span>
        ...
        <a
          href="#"
          className="block w-full py-2.5 text-center text-[12px] font-black uppercase tracking-wide border border-white/30 text-white/85 hover:bg-white/5 transition-colors"
          style={{ fontFamily: 'var(--font-barlow-condensed)' }}
        >
