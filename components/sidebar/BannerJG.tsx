  ...
  return (
    ...
    >
      <div className="mb-3">
        ...
        <p className="text-[11px] text-white/60 mt-0.5">Fornecedor oficial do setor</p>
      </div>
      ...
      <a
        href="#"
        className="block w-full py-2.5 text-center text-[12px] font-black uppercase tracking-wide bg-acc text-[#111] hover:bg-yellow-300 transition-colors"
        style={{ fontFamily: 'var(--font-barlow-condensed)' }}
      >
